...
class OrderService {
    async createOrder(req){
        try{
          ...
          const {transactionid, serviceid} = req.headers;
            console.info(
                `Request to POST new order with data ${JSON.stringify(orderData)} | transactionID: ${transactionid} | serviceID: ${serviceid}`
                )
            ...
            console.info(
              `Response to POST new order with data ${JSON.stringify(response)} | transactionID: ${transactionid} | serviceID: ${serviceid}`
              )
            return response;
    ...
    async findById(req) {
        try {
          ...
          const {transactionid, serviceid} = req.headers;
            console.info(
                `Request to GET order by ID with data ${JSON.stringify(id)} | transactionID: ${transactionid} | serviceID: ${serviceid}`
                )
